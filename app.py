...
WEBSITE_REGEX = re.compile(r'(https?://[^\s]+|www\.[^\s]+)')
...
def main():
    ...
    if not TESSERACT_AVAILABLE:
        ...
        **OCR engine not available.** 
        ...
        This app needs Tesseract OCR to work. On Streamlit Cloud, we need to use a different approach.
        
        Please use this alternative version that works with external OCR API.
        """)
        return
